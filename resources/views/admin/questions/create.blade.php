...
<form method="POST" action="{{ route('dashboard.course.question.store', $course) }}" enctype="multipart/form-data"
    ...
    <div class="flex gap-5 items-center">
        ...
        <div class="relative w-[500px] h-[250px] overflow-hidden peer-data-[empty=true]:border-[3px] peer-data-[empty=true]:border-dashed peer-data-[empty=true]:border-[#EEEEEE]">
            ...
            <span class="absolute transform -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2 text-center font-semibold
                text-sm text-[#7F8190]">
                <i class="fa-solid fa-cloud-arrow-up mr-2" style="font-size: 20px"></i>
                Gambar Soal <br>(Opsional)
            </span>
        </div>
        <button type="button" class="flex shrink-0 p-[8px_20px] h-fit items-center rounded-full bg-[#0A090B]
            font-semibold text-white" onclick="document.getElementById('icon').click()">
            <i class="fa-solid fa-cloud-arrow-up mr-2" style="font-size: 20px"></i>
    ...
    <div class="flex flex-col gap-[10px]">
        ...
        <textarea id="question" name="question" class="font-semibold placeholder:text-[#7F8190] placeholder:font-normal
        w-full outline-none"></textarea>
    </div>
    <div class="flex flex-col gap-[10px]">
        <p class="font-semibold">Answers</p>
        @for($i = 0; $i < 5; $i++)
        <div class="flex items-center gap-4">
            <div class="flex items-center w-[940px] h-[52px] p-[14px_16px] rounded-full border border-[#EEEEEE]
    ...
    <div class="flex flex-col gap-[10px]">
        ...
        <div class="flex items-center w-[1140px] p-[14px_16px] rounded-md border border-[#EEEEEE]">
            ...
            placeholder="Write the explanation"></textarea>
        </div>
    </div>
