...
<div class="flex flex-col gap-10 px-5 mt-5">
    <div class="breadcrumb flex items-center gap-[30px]">
        ...
        <a href="index.html" class="text-[#7F8190] last:text-[#0A090B] last:font-semibold">Manage Users</a>
    </div>
</div>
...
<div class="flex flex-col px-5 mt-5">
    <div class="w-full flex justify-between items-center">
        <div class="flex flex-col gap-1">
            <p class="font-extrabold text-[30px] leading-[45px]">Manage Users</p>
            <p class="text-[#7F8190]">Organize mentors and users data</p>
        </div>
        <div class="flex items-center space-x-5"> <!-- Container untuk tombol dan form search -->
            ...
            <a href="{{ route('dashboard.courses.create') }}" class="h-[52px] p-[14px_20px] bg-[#2B82FE] rounded-full
                font-bold text-white transition-all duration-300 hover:shadow-[0_4px_15px_0_#2B82FE4D]">Add New User</a>
        </div>
    </div>
</div>
...
<div class="course-list-container flex flex-col px-5 mt-[30px] gap-[30px]">
    ...
    <div class="list-items flex flex-nowrap justify-between pr-10">
        ...
        <div class="flex shrink-0 w-[120px] items-center justify-center">
            @if($student->roles()->exists())
                <p class="font-semibold">{{ $student->roles()->first()->name }}</p>
            @else
