...
<div class="flex flex-col gap-10 px-5 mt-5">
    <div class="breadcrumb flex items-center gap-[30px]">
        ...
        <span class="text-[#7F8190] last:text-[#0A090B]">/</span>
        <a href="#" class="text-[#7F8190] last:text-[#0A090B] last:font-semibold ">Paket Soal Baru</a>
    </div>
</div>
...
<form enctype="multipart/form-data" method="post" class="flex flex-col gap-[30px] w-[700px] mx-[70px] mt-10" id="createCourseForm"
    ...
    <div class="flex flex-col gap-[10px]">
        ...
        <input type="text" class="font-semibold placeholder:text-[#7F8190] placeholder:font-normal w-full outline-none" placeholder="Write your package name" name="name" >
        </div>

        <p class="font-semibold">Description</p>
        <textarea class="h-[150px] p-[14px_16px] rounded-lg border border-[#EEEEEE] focus-within:border-2
            focus-within:border-[#0A090B]" placeholder="Write your package description" name="description" ></textarea>
        ...
        <div class="grid grid-cols-2 gap-5">
            <div class="flex flex-col">
                ...
                <div class="flex items-center w-full h-[52px] p-[14px_16px] rounded-full border border-[#EEEEEE] transition-all duration-300 focus-within:border-2 focus-within:border-[#0A090B]">
                    <input type="number" class="font-semibold w-full outline-none" placeholder="0" name="total_duration" step="0" >
            ...
            <div class="flex flex-col">
                ...
                <div class="flex items-center w-full h-[52px] p-[14px_16px] rounded-full border border-[#EEEEEE] transition-all duration-300 focus-within:border-2 focus-within:border-[#0A090B]">
                <input type="number" class="font-semibold w-full outline-none" placeholder="0" name="total_question" >
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-2 gap-5">
        <div class="flex flex-col gap-[10px]">
            ...
            <div class="flex items-center w-full h-[52px] p-[14px_16px] rounded-full border border-[#EEEEEE] transition-all duration-300 focus-within:border-2 focus-within:border-[#0A090B]">
                ...
                <input type="text" name="price" id="price" class="font-semibold w-full outline-none" placeholder="0.00"  step="1" >
            </div>
        </div>
        ...
        <div class="flex flex-col gap-[10px]">
            ...
            <div class="flex items-center w-full h-[52px] p-[14px_16px] rounded-full border border-[#EEEEEE] transition-all duration-300 focus-within:border-2 focus-within:border-[#0A090B]">
                <span class="mr-[14px] text-[#7F8190]">Rp</span>
                <input type="text" name="discount" id="discount" class="font-semibold w-full outline-none" placeholder="0.00" step="1">
            </div>
        </div>
    </div>
    ...
    <div class="flex flex-col gap-[10px]">
        <p class="font-semibold">Is Premium</p>
        <div class="flex items-center gap-5">
            <label for="togglePremium" class="flex items-center gap-[10px]">
                <input type="checkbox" id="togglePremium" class="hidden" value="0" name="is_premium">
                <div class="toggle-switch"></div>
                <span id="toggleTextPremium" class="text-gray-600">Is Free</span>
            </label>
        </div>
    </div>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        togglePremium.addEventListener('change', function() {
            const status = togglePremium.checked ? 1 : 0; // Changed from toggle to togglePremium
