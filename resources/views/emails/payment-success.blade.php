...
<head>
  ...
  <title>Terima Kasih Pembelian Sudah Berhasil</title>
  <style>
      ...
      <div class="order-details">
        ...
        <table>
          ...
          <tr>
            ...
            <td><strong>{{ $transaction->payment_number }}</strong></td>
          </tr>
          <tr>
            <th>Pembayaran</th>
          ...
          <tr>
            <th>Batas Bayar</th>
            <td><strong>{{ \Carbon\Carbon::parse($transaction->payment_expired)->setTimezone('Asia/Jakarta')->format('d F Y H:i') }}</strong></td>
          </tr>
        </table>
      </div>
      {{-- cheers --}}
